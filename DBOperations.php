...
public function __construct() {
 ...
 public function insertData($name, $email,$phNo,$nrc, $password,$address,$dob,$gender,$cardNo){
	...
	$salt = $hash["salt"];
 	...
 	$sql = 'INSERT INTO user SET fullname =:name,
    email =:email,phNo=:phNo,nrc=:nrc,password =:password,address =:address,dob =:dob,gender =:gender,cardNo =:cardNo,salt =:salt';
