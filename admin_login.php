	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(admin_login/images/bg-01.jpg);">
				...
				<form class="login100-form validate-form" >
					<div class="wrap-input100 validate-input m-b-26" data-validate="Email is required">
						...
						<input class="input100" type="text" name="admin_email" placeholder="Enter Email">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						<span class="label-input100">Admin Password</span>
						<input class="input100" type="password" name="admin_pass" placeholder="Enter password">
						<span class="focus-input100"></span>
					</div>
