  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="auction_price.php">Auction Price List</a>
        <!-- Form -->
          ...
          <div class="card shadow">
            ...
            <?php 
              if(isset($_GET['delete'])){
                  $price_id=$_GET['delete'];
                  $query="DELETE FROM auction_price WHERE price_id=$price_id";
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $no=1;
                    $query="SELECT * FROM auction_price";
                    $result=mysqli_query($conn,$query);
                    if(!$result){
                  ...
                  <tr>
                    ...
                    <td>
                      <a onclick="javaScript: return confirm('Are You Sure To Delete?')" href="auction_price.php?delete=<?php echo $price_id ?>" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
                  <?php
                  $no++;
