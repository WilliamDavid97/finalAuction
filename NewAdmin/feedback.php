  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="feedback.php">Feedback</a>
        <!-- Form -->
        ...
        <div class="col-md-12">
          ...
          <?php
              ...
              switch ($source) {
                  ...
                  include_once "include_admin/update_feedback.php";
                  break;
                  default:
                      include_once "include_admin/view_all_feedback.php";
                      break;
              }
         ?>
